...
const DoctorDashboard = () => {
  ...
  return (
    <div className='flex text-white flex-col py-10 min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 px-4 gap-7'>
      <Link to={"/"}>
      <div className='px-4 py-2 bg-gray-600/20 w-fit  border-gray-300 border rounded-md flex gap-2  from-gray-900 via-black to-gray-800 '><RiArrowLeftBoxFill/> Back To Home </div>
      </Link>
      <div className='flex gap-2 items-center text-4xl font-black'> <div><RiStethoscopeLine className="w-10 h-10" /></div> <h1>Doctor Dashboard</h1></div>
